...
namespace RazorPages.Migrations
{
    ...
    [Migration("20221130030433_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2022, 11, 29, 22, 4, 33, 549, DateTimeKind.Local).AddTicks(6877),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2022, 11, 29, 22, 4, 33, 552, DateTimeKind.Local).AddTicks(8109),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2022, 11, 29, 22, 4, 33, 552, DateTimeKind.Local).AddTicks(8159),
                            ServicesID = 5
                        });
                });
